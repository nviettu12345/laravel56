                            ...
                            <div class="single-footer mb-sm-40">
                                ...
                                <div class="footer-content">
                                    ...
                                    <div class="payment mt-25 bdr-top pt-30">
                                        <a href="#"><img class="img" src="{{asset('site')}}/img/payment/1.png" alt="payment-image"></a>
                                    </div>                                   
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="footer-middle-content pt-20 pb-30">
                            <ul class="social-footer">
                                ...
                                <li><a href="#"><img src="{{asset('site')}}/img/icon/social-img1.png" alt="google play"></a></li>
                                <li><a href="#"><img src="{{asset('site')}}/img/icon/social-img2.png" alt="app store"></a></li>
                            </ul>
                    </div>
                </div>
                <!-- Container End -->
